...
@Entity
@Table(name = "its_it_work_report_del")
@Getter
@Setter
@NoArgsConstructor
@AllArgsConstructor
@Builder
public class ItWorkReportDelVo {

    @Id
    @Column(name = "INST_ID", length = 14, nullable = false, columnDefinition = "VARCHAR(14) COMMENT '처리번호'")
    private String instId;

    @Column(name = "REQ_ID", length = 14, columnDefinition = "VARCHAR(14) COMMENT '요청번호'")
    ...
    @Column(name = "SERVICE_TYPE", length = 2, columnDefinition = "VARCHAR(2) COMMENT '서비스구분'")
    ...
    @Column(name = "WORK_TYPE", length = 2, columnDefinition = "VARCHAR(2) COMMENT '작업타입'")
    ...
    @Column(name = "WORK_START_DT", length = 14, columnDefinition = "VARCHAR(14) COMMENT '지시시작일'")
    private String workStartDt;

    @Column(name = "WORK_END_DT", length = 14, columnDefinition = "VARCHAR(14) COMMENT '지시종료일'")
    ...
    @Column(name = "DEL_DT", length = 14, columnDefinition = "VARCHAR(14) COMMENT '삭제일'")
    private String delDt;

    @Column(name = "DEL_SABUN", length = 10, columnDefinition = "VARCHAR(10) COMMENT '삭제자사번'")
    private String delSabun;
}
